    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:gap-6">
        <Card>
          <CardHeader className="flex flex-col px-4">
            <CardTitle className="flex flex-col items-start md:gap-4 gap-3 w-full">
              ...
              <span className="text-sm sm:text-2xl text-debt">{formatIDR(totalMonthlyPayment)}</span>
            </CardTitle>
          </CardHeader>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-col px-4">
            <CardTitle className="flex flex-col items-start md:gap-4 gap-3 w-full">
              <span className="text-primary text-xs md:text-lg">Sisa Hutang</span>
              <span className="text-sm sm:text-2xl text-debt">{formatIDR(totalRemainingAmount)}</span>
            </CardTitle>
          </CardHeader>
        </Card>
      </div>
