      ...
      <Card className="bg-card border-1 py-4 md:py-6">
        <CardHeader className="flex flex-col px-4">
          <CardTitle className="flex flex-col items-start md:gap-4 gap-3 w-full">
            <span className="text-primary text-sm md:text-lg">Total Pemasukkan</span>
            <span className="text-md sm:text-2xl text-income">{formatIDR(totalAll)}</span>
          </CardTitle>
        </CardHeader>
      </Card>
            ...
            >
              <CardContent className="p-4 md:px-6 md:py-0 flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-3 md:gap-2">
                  ...
                  <p className="md:text-lg text-sm font-bold text-income">{formatIDR(summary.total)}</p>
                </div>
              </CardContent>
            </Card>
          ))}
